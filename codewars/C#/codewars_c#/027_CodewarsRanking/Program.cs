...
Minden alkalommal, amikor a felhasználó végrehajt egy rangsorolt ​​tevékenységet, a felhasználók rangsorolásának előrehaladása a tevékenység rangsorolása alapján frissül
A befejezett tevékenység által elért előrehaladás a felhasználó aktuális rangjához viszonyítva a tevékenység rangjához képest
A felhasználó rangsorolása nulláról indul, és minden alkalommal, amikor az előrehaladás eléri a 100-at, a felhasználó rangja a következő szintre emelkedik
Bármilyen hátralévő haladás, amelyet az előző fokozatban szerzett, a következő rangban elért előrehaladása során érvényesül (nem dobunk el). Kivételt képez, ha már nincs más fokozat, ahová tovább lehet lépni (a 8. fokozat elérése után nincs továbblépés).
...
A rendszer figyelmen kívül hagyja azokat a tevékenységeket, amelyek legalább 2 szinttel alacsonyabbak, mint a felhasználó rangsorolása
Az aktuális felhasználó rangjánál magasabb rangú tevékenység elvégzése felgyorsítja a rangsorolást. Minél nagyobb a rangsorok közötti különbség, annál nagyobb lesz az előrehaladás. A képlet 10 * d * d, ahol d egyenlő a tevékenység és a felhasználó rangsorolási különbségével.
Logikai példák:
...
Ha egy -8-as rangú felhasználó végrehajt egy -4-es rangú tevékenységet, akkor 160-as előrelépést kap, ami azt eredményezi, hogy a felhasználó -7-es rangra emelkedik, és 60-at ér el a következő rangra.
Ha egy -1-es besorolású felhasználó egy 1-es rangú tevékenységet végez, 10-et kap (ne feledje, a nulla helyezést figyelmen kívül hagyja)
