...
create or alter procedure uspSendMail(
	@accost nvarchar(100) = 'Tisztelt Ügyfelünk!',
	@message nvarchar(max) = 'A WebDoki rendszerben kezdeményezett időpontfoglalása sikeres!',	
	@subject nvarchar(100) = 'Időpontfoglalás visszaigazolása',
	@recipient nvarchar(300) = 'recipient@email.hu'
) as

declare @currentdate nvarchar(20) = getdate()
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_1 .v-font-size { font-size: 63px !important; } #u_content_heading_1 .v-line-height { line-height: 100% !important; } #u_column_3 .v-col-border { border-top: 1px solid #CCC !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 1px solid #CCC !important; } #u_content_text_1 .v-text-align { text-align: center !important; } #u_content_heading_2 .v-text-align { text-align: center !important; } #u_content_text_4 .v-container-padding-padding { padding: 5px 10px 20px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } #u_content_text_13 .v-container-padding-padding { padding: 10px 10px 20px !important; } }
    </style>
...
<div class="u-row-container" style="padding: 0px;background-color: #ccecee">
  <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
    <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
      <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: #ccecee;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->
...
<table id="u_content_heading_1" style="font-family:''Raleway'',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 100%; text-align: center; word-wrap: break-word; font-family: Arvo; font-size: 119px; font-weight: 400;"><span><span><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><span style="line-height: 63px;"><strong>WebDoki</strong></span></span></span></span></span></span></span></span></span></span></h1>
...
<table id="u_content_text_1" style="font-family:''Raleway'',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-line-height v-font-size" style="font-size: 14px; line-height: 140%; text-align: right; word-wrap: break-word;">
    <p style="line-height: 140%;">'+@currentdate+'</p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://devnullsec.hu/webdoki.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 580px;" width="580"/>
...
<table id="u_content_heading_2" style="font-family:''Raleway'',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: Arvo; font-size: 30px; font-weight: 400;"><span><span><span><span><strong>'+@accost+'</strong></span></span></span></span></h1>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table id="u_content_text_13" style="font-family:''Raleway'',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 100px 30px;font-family:''Raleway'',sans-serif;" align="center">
  ...
  <div class="v-text-align v-line-height v-font-size" style="font-size: 14px; line-height: 170%; text-align: left; word-wrap: break-word;">
    <hr>
	<p style="font-size: 14px; line-height: 170%;">Ez a WenDoki automata üzenete ne válaszoljon rá.</p>
  </div>
